...
public class BPlusTree implements Serializable {
    ...
    private class InternalNode extends Node {
         ...
         * degree of children.
         * @return a boolean indicating whether the InternalNode can be
         * merged with
         */
    ...
    public class LeafNode extends Node {
         ...
         * dictionary is sorted, and true is returned. If the method
         ...
         * @return a boolean indicating whether the LeafNode is deficient
         */
         ...
         * @return a boolean indicating whether the LeafNode is full
         */
         ...
         * @return a boolean indicating whether the LeafNode object can
         ...
         */
        private LeafNode(int m, DictionaryPair[] dps, InternalNode parent) {
            this.maxNumPairs = m - 1;
            this.minNumPairs = (int)(Math.ceil((double)m/2) - 1);
            this.dictionary = dps;
    ...
    public static class DictionaryPair implements Comparable<DictionaryPair>, Serializable {
         ...
         * @param o the DictionaryPair object to be compared with
